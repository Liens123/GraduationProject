package org.example.graduation_project.api.constant;

/**
 * Created by liboyu on 2025/4/5.
 */

public class InnerApiConstant {
    public static final String INNER_PREFIX = "/api/v1/graduation/web/inner";
